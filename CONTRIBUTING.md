...
First step is to fork this repository (rahulsain/PersonalTODOList) to your GitHub account. You can do this by clicking on the Fork button provided in the top right corner of the repo page. 
...
Be careful to clone the forked repo (your-username/PersonalTODOList) and not the main repo (rahulsain/PersonalTODOList) as making direct changes to the main repo will result in conflict of code and lack of co-ordination as we proceed further.
...
`git remote add upstream https://github.com/rahulsain/PersonalTODOList.git` to point to the main repository. You only need to do this once.
