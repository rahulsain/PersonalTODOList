...
First step is to fork this repository (rahulsain3000/PersonalTODOList) to your GitHub account. You can do this by clicking on the Fork button provided in the top right corner of the repo page. 
...
Be careful to clone the forked repo (your-username/PersonalTODOList) and not the main repo (rahulsain3000/PersonalTODOList) as making direct changes to the main repo will result in conflict of code and lack of co-ordination as we proceed further.

The forked repository will have your username in the top left corner and the clone link will also contain your username (https://github.com/your-username/PersonalTODOList.git).
...
So, after cloning the forked repository (your-username/PersonalTODOList) to your system, use the command
`git remote add upstream https://github.com/rahulsain3000/PersonalTODOList.git` to point to the main repository. You only need to do this once.
...
After pushing the changes to your forked repository (your-username/PersonalTODOList), all you have to do is create a new pull request from your account by simply clicking on the *Pull Request* button.
